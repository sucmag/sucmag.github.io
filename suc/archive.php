<?php
 ...
 <section id="archive" class="sub-hero">
   <div class="container">
     <div class="title-control">
   <h1 id="hero-title">Archive</h1>
 </div>
 <div class="subtitle-control">
   <h4 id="hero-subtitle">View every single article done by the Southern Utah Culture magazine team
</h4>
</div>
 </div>
 </section>
